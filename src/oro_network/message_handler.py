...
if TYPE_CHECKING:
    ...
    from .node import PendingAck, PendingMessage
...
class MessageHandler:
    ...
    def __init__(
        ...
        config: MessageHandlerConfig | None = None,
        traffic_mitigation_config: TrafficAnalysisMitigationConfig | None = None,
    ...
    async def send_message(
        ...
        content: bytes,
        router_selector: Callable[[], RouterInfo | None],
    ...
    async def _send_message_direct(
        ...
        from .node import NoRoutersAvailableError, PendingAck, PendingMessage
    ...
    async def _add_to_batch(
        ...
        async with self._batch_lock:
            ...
            if (
                ...
                and len(self._message_batch) >= self.traffic_mitigation_config.batching.max_batch_size
            ):
